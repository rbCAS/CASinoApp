...
ActiveRecord::Schema.define(version: 20160606233538) do
  ...
  add_index "casino_ticket_granting_tickets", ["deleted_at"], name: "index_casino_ticket_granting_tickets_on_deleted_at", using: :btree
